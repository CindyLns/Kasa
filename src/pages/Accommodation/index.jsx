...
function Accommodation() {
    ...
    const logement = data.find(item => item.id === accommodationId);
            ...
            <div className='slide-row'>
                <div className="slide-col">
                    <div className="slide-title">
                        <h2 className='slide-name'>{logement.title}</h2>
                        <p className='slide-location'>{logement.location}</p>
                    </div>
                    <ul className="slide-tag">           
                ...
                <div className="slide-col-right">
                    <div className="slide-host">
                        ...
                        <img className="picture-host" src={logement.host.picture} alt={logement.host.name} />
                    </div>
